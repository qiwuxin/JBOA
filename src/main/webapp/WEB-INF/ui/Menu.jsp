...
<body data-id="${requestScope.user.employeeId }" id="employeeId">
				...
				<ul
					...
					<li>
						<dl>
							...
							<c:if test="${requestScope.user.positionId!=0 }">
								<dd
					...
					<c:if test="${requestScope.user.positionName=='部门经理'|| requestScope.user.positionName=='总经理'}">
						<li>
							<dl>
								<dt
	...
	<footer style="height: 50px;background: #4e93bb">
	</footer>
</body>
